      ...
      {show && (
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse 70% 60% at 50% 50%, rgba(123,3,35,0.13) 0%, transparent 70%)",
            }}
          />
          ...
          >
            ...
            <div
              className="w-10 mb-8"
              style={{ height: "1px", backgroundColor: "rgba(245,240,232,0.2)" }}
            />
            ...
            {!denied ? (
              <>
                ...
                <p
                  ...
                  style={{ color: "rgba(245,240,232,0.45)", maxWidth: "320px" }}
                >
              ...
              >
                ...
                <p
                  ...
                  style={{ color: "rgba(245,240,232,0.4)", maxWidth: "300px" }}
                >
